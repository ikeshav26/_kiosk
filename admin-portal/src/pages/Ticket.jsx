      ...
      <div className="max-w-5xl mx-auto space-y-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
          <div className="bg-white rounded-2xl border border-slate-100 shadow-sm p-5 flex items-start gap-4">
            ...
            <div>
              <p className="text-[10px] font-black text-slate-300 uppercase tracking-widest mb-1.5">Reported By</p>
              <p className="text-sm font-bold text-slate-800">{data.helperName || 'Not Provided'}</p>
            </div>
          </div>
          ...
          <div className="bg-white rounded-2xl border border-slate-100 shadow-sm p-5 flex items-start gap-4">
            ...
            <div>
              <p className="text-[10px] font-black text-slate-300 uppercase tracking-widest mb-1.5">Contact Number</p>
              <p className="text-sm font-bold text-slate-800">{data.helperContactNumber || 'Not Provided'}</p>
            </div>
          </div>
          ...
          <div className="bg-white rounded-2xl border border-slate-100 shadow-sm p-5 flex items-start gap-4">
            ...
            <div>
              <p className="text-[10px] font-black text-slate-300 uppercase tracking-widest mb-1.5">Category</p>
              <p className="text-sm font-bold text-slate-800 capitalize">{data.category || 'Not Specified'}</p>
            </div>
          </div>
        </div>
        ...
        <div className="flex items-center gap-6 px-2 text-slate-500">
          <div className="flex items-center gap-2">
            ...
            <span className="text-xs font-semibold">{new Date(data.createdAt).toLocaleDateString()}</span>
          </div>
          <div className="flex items-center gap-2">
            <Clock size={14} className="text-slate-400" />
            <span className="text-xs font-semibold">{new Date(data.createdAt).toLocaleTimeString()}</span>
          </div>
        </div>
